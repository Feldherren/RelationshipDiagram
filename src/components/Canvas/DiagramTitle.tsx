...
import { getDiagramHeaderPillClassName } from "../../utils/diagramHeaderPill";
...
export function DiagramTitle() {
  ...
  const pillStyle = (chrome: typeof titleLabel) => ({
    fontFamily,
